...
from pl_datamodules import IsprsVaiSemisup, MiniworldSemisup
...
def main():
    ...
    # to the parser
    parser = MiniworldSemisup.add_model_specific_args(parser)
    ...
    pl_datamodule = MiniworldSemisup(**args_dict)
